        ...
        <div class="woonuxt-header-content">
            ...
            <div class="woonuxt-header-actions">
                <?php if (!empty($options['frontEndUrl'])): ?>
                    <a href="<?php echo esc_url($options['frontEndUrl']); ?>" target="_blank" rel="noopener noreferrer" class="woonuxt-visit-btn" title="<?php esc_attr_e('Open your site in a new tab', 'woonuxt'); ?>">
